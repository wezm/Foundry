 ...
 $.fn.columnize = function(options) {
    ...
    return this.each(function() {
		...
		function singleColumnizeIt() {
			...
			$inBox.empty();
			$inBox.append($("<div class='first last column' style='width:98%; padding: 3px; float: " + options.colFloat + ";'></div>")); //"
...
//			}
			...
			$inBox.empty();
			$inBox.append($("<div style='width:" + (Math.round(100 / numCols) - 2)+ "%; padding: 3px; float: " + options.colFloat + ";'></div>")); //"
			...
			for(var loopCount=0;loopCount<maxLoops;loopCount++){
				...
				for (var i = 0; i < numCols; i++) {
					...
					$inBox.append($("<div class='" + className + "' style='width:" + (Math.round(100 / numCols) - 2)+ "%; float: " + options.colFloat + ";'></div>")); //"
				}
